...
def help(rc=0):
    ...
    print("%s - REPL & file ops via MicroPython WebREPL" % exename)
    print("Usage:")
    print("  %s [-p password] <host>                            - REPL")
    print("  %s [-p password] <host>:<remote_file> <local_file> - Remote -> local")
    print("  %s [-p password] <local_file> <host>:<remote_file> - Local -> remote")
    print("  e.g.: %s 192.168.7.61" % exename)
    sys.exit(rc)
